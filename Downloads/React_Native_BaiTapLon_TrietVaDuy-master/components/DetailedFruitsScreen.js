...
const FruitDetailScreen = ({ route }) => {
  const { fruit } = route.params;  // Nhận dữ liệu từ màn hình trước
  ...
  const handleBuyNow = () => {
    addToCart(fruit);  // Thêm trái cây vào giỏ hàng
    Alert.alert('Đã thêm vào giỏ hàng');
  };

  const handleFavoritePress = () => {
    addToFavorites(fruit);  // Thêm sản phẩm vào yêu thích
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.priceRatingContainer}>
        ...
        <View style={styles.ratingContainer}>
          ...
          <Text style={styles.ratingText}>{fruit.rating}</Text>
          <Text style={styles.reviewCount}>({fruit.reviews} đánh giá)</Text>
        </View>
      </View>
